...
## Installation
 ...
 - a data volume for writing downloaded files (`/path/to/data` - the test dataset and models required to run the pipeline will be automatically downloadeded during container startup)
