...
wget -P /data https://sandbox.zenodo.org/record/34881/files/MapMetIP_models.zip
unzip /data/MapMetIP_models.zip -d /data

wget -P /data https://sandbox.zenodo.org/records/34881/files/MapMetIP_TestDataset.zip
